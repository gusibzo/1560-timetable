...
text = text.replace("Rev.68", "Rev.71")
text = text.replace(
...
sw_text = re.sub(r'const CACHE_NAME="[^"]+";', 'const CACHE_NAME="1560-timetable-rev71-v1";', sw_text)
sw_text = re.sub(r'const REVISION="[^"]+";', 'const REVISION="71";', sw_text)
